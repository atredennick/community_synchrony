...
Abstract
-------------
Temporal asynchrony among interacting species is an important mechanism through which species richness can stabilize biomass production through time. While asynchrony is a key mechanism linking biodiversity and ecosystem function, empirical support for the prevalance species asynchrony is mixed, and no studies have rigorously disentangled the forces driving species (a)synchrony in nature. Theory identifies three drivers of species synchrony: inter- and intraspecific density dependence sychronize dynamics, demographic stochasticity desynchronize dynamics, and environmental forcing can either synchronize or desynchronize poplation dynamics depending on the correlation of species-specific environmental responses. Here we use stochastic population models fit using long term datasets from five semi-arid grasslands to identify the forces that increase or decrease species synchrony through time. We find that the trophically-similar grass species in our dataset have population dynamics that are synchronized by similar responses to environmental fluctuations. Species interactions tend to be weak, so removing interspecific competition did not reduce synchrony. The effect of demographic stochasticity depended on the spatial scale of our modeling. Though we found that similar responses to environmental fluctuations synchronized species, dynamics were not completly synchronous. We conclude that niche differentiation among species is strong enough to reduce the synchronizing effect of coupled density dependence via competition, but this is countered by the synchronizing effect of similar environmental responses. The next frontier is to identify the specific environmental drivers of species synchrony to inform predictive efforts.  
