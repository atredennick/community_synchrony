...
*Andrew Tredennick, Peter Adler, Claire de Mazancourt, Michele Loreau, and Stephen Ellner*

Quick summary
-------------
1. __Question__. How (a)synchronous are species population dynamics in natural communities, and what determines the degree of synchrony among species? Of particular interest to us, do species' responses to environmental fluction increase or decrease population synchrony?

2. __Data__. Five longterm demographic datasets from semi-arid North American grasslands. All species coexist stabley, yet are similar -- they are all perennial grasses.

3. __Analysis__. (a) Calculate community synchrony from the observed time series using an established metric, and compare this to expectation from theory. (b) Use IPMs with environmental or demographic stochasticity turned on/off to quantify the relative contribution of each to community synchrony.

4. __Initial conclusions__. Species' responses to environmental fluctuations tend to synchronize population dynamics: at four of the five sites removing environmental fluctuations decreased community synchrony. However, even with environmental fluctuations present, populations were not completely synchronized. This implies that niche differences among these species remain strong even as they respond similarly to environmental conditions.
