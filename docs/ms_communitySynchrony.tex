...
with analytical predictions and observed synchrony (Figs. S2-S3).
...
that analyses based on synchrony of species' percent cover were
uninformative (Figs. S2-S3), implying that it is difficult to decipher
mechanisms of species synchrony from abundance time series, as expected
by theory (Loreau and {{de Mazancourt}} 2008).
