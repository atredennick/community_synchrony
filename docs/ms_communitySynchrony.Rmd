...
Introduction
------------
Biodiversity tends to confer ecosystem stability in the face of environmental fluctuations [@Hector2010; @DeMazancourt2013a; @Hautier2014].
In the absence of a highly dominant and stable species, asynchronous population dynamics (also called compensatory dynamics) among interacting species is the only way for biodiversity to stabilize aggregate community or ecosystem function [@Loreau2013].
Experimental work in grassland communities provides strong evidence for the stabilizing effect of asynchronous population dynamics [@DeMazancourt2013a; @Gross2014; @Hautier2014], but how theoretical mechanisms of species asynchrony link to observed dynamics remains unclear [@Loreau2008a; @Gonzalez2009].
Futhermore, analyses of observational time series tend to show synchronous, rather than asynchrounous, population dynamics among species of similar ecology (e.g., compete for and use similar resources) [@Houlahan2007; @Rocha2011; @Vasseur2014].
Thus, our understanding of the prevelance and drivers of asynchronous population dynamics is murky at best.
Only by fully understanding the mechanisms that lead to asynchronous, or synchronous, in natural ecosystems can we predict how future biodiversity loss may impact ecosystem functioning [@Loreau2010].
