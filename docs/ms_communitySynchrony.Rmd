...
One way to quantify the importance of environmental stochasticity on synchrony is to compare species synchrony when grown in monoculture versus when grown in polyculture [@Gross2014].
The assumption is that synchrony in monoculture is representative of the synchrony of species' environmental responses.
A more direct measure of a species' environmental response is the low density growth rate in a given year in the absence of interspecific competition because then only the environment is influencing the change in abundance [@Adler2010].
Thus, we compare species synchrony in polyculture (equilibrium densities, with species interactions) to species synchrony in monoculture (equilibrium densities, no species interactions) and to the synchrony of low density growth rates (low densities, no species interactions).
The difference between synchrony of per capita growth rates in monoculture at equilibrium versus low densities represents the effect of intraspecific density-dependence.
