...
A null expectation based on demographic stochasticity operating alone is problematic, however, because its affect is strong only in small populations.
...
Discussion
----------
Temporal asynchrony among interacting populations can stabilize ecosystem-level function and is influenced by inter and intraspecific competition, demographic stochasticity, and environmental fluctuations [@Loreau2013a].
