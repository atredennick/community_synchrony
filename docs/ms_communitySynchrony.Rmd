...
Species interactions are weak in this communitie (Table SX), so removing interspecific competition had little effect on synchrony (Fig. 2a; "No Comp." simulations).
...
In the absence of demographic stochasticity, community synchrony was virtually indistinguishable between simulations with and without interspecific interactions (Fig. 2a).
