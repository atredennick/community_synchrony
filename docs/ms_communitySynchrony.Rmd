...
When parameterized with empirical estimates, our prediction under the limiting case of only environmental stochasticity operating best explains observed synchrony of per capita growth rates.
...
Our results suggest that all five communities represent the theoretical limiting case where demographic stochasticity and competition are weak, and community-wide synchrony is approximately equal to the synchrony of species' environmental responses.
\end{abstract}
...
Across the five communities, our limiting case prediction of community-wide synchrony when only environmental stochasticity is operating best matched observed synchrony for per capita growth rates (Fig. 1).
...
The regression lines between observed and predicted growth rates under prediction $\mathcal{M}_D$ had intercepts or slopes significantly different from zero or one, respectively, for both percent cover and per capita growth rates.
