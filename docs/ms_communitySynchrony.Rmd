...
We also use simulation results from species growing in monoculture to estimate the covariance of species' responses to the environment ($cov(u_{ie}, u_{je})$) for parameterizing Equations 5-6.
