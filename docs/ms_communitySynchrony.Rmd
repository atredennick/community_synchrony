...
Even in small populations, however, demographic stochasticity was not strong enough to completely counteract the synchronizing effects of environmental fluctuations and induce independent species fluctuations (Fig. 2).
...
Only in the Idaho community does synchrony of per capita growth rates approach independent fluctuations (1/*S*, where *S* is the number of species) in a non-constant environment (Fig. 2).
...
Thus, our results suggest that community-wide species synchrony will increase as the observation area increases.
