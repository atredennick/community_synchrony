...
Theory identifies three drivers of species synchrony: inter- and intraspecific density dependence, demographic stochasticity, and environmental forcing.
However, general trends between synchrony and its drivers are elusive except in special limiting cases.
Here we use stochastic population models fit using long term datasets from five semi-arid grasslands to identify the forces that increase or decrease species synchrony.
...
Our results are in contrast to a recent analysis of several biodiversity-ecosystem function experiments that found species asynchrony to be driven by competition.
We propose that such differences are due to community assembly processes: recently assembled communities, such as experimental plots, may exhibit strong species interactions that will weaken over time.
