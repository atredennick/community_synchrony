...
Indeed, results from an IBM with infinite population size would equal results from the IPM.
...
Our analysis of how demographic stochasticity affects synchrony across population sizes also demonstrates that synchrony depends on the observation area.
