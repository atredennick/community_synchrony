...
# Disentangling the drivers of species synchrony in natural grasslands: environmental forcing, demographic stochasticity, and interspecific interactions
...
Introduction
------------
Biodiversity tends to stabilize ecosystem function in the face of environmental fluctuations [@Hector2010; @DeMazancourt2013a; @Hautier2014].
...
However, three sources of confusion have limited our understanding of community synchrony: (1) the metric of synchrony, (2) the baseline expectation of synchrony, and (3) the use of population abundances to calculate synchrony.
Recent theoretical work has clarified all three sources of confusion [@Loreau2008a; @Loreau2010].
...
The metric of @Loreau2008 makes clear that synchrony and asynchrony are not binary states, contrary to their common usage in the literature.
...
Thus, our focus should not be on whether or not (a)synchronous dynamics occur, but instead on the degree of (a)synchrony.
Prior to Loreau and de Mazancourt's (2008) work, the synchrony metric of choice was summed community covariance [e.g., @Ives1995; @Klug2000; @Fischer2001; @Houlahan2007].
However, @Ranta2008 show that the summed community covariance method cannot be used to detect asynchrony or its drivers because values of summed covariance are not exclusive to particular combinations of drivers.
For example, contrary to prevailing belief, negative community covariance can occur in the absence of competition and positive community covariance can occur in the presence of strong competitive interactions [@Loreau2008a; @Ranta2008].
Likewise, positively covarying abundances and negatively covarying environmental responses are not mutually exclusive [@Loreau2008a].
In the end, the fact that few communities exhibited negative summed covariance yields little insight as to whether communities tend to be sychronized by environmental forces or not [@Loreau2010].
The use of summed community covariance also relied on the null expectation that species fluctuate independently [@Ranta2008], which need not be the case [@Loreau2008; @Loreau2010]. 

Indeed, there is not a single baseline expectation for community synchrony.
...
The relative strengths of those three forces determine the degree of synchrony in population dynamics [@Loreau2008a].


All organisms exist in variable environments, and those that coexist on similar resources should be expected to respond to the environment in similar ways [@Rocha2011].
Based on such a proposition, @Loreau2008a suggest that a more appropriate null hypothesis is that coexisting species should fluctuate synchronously, not independently, in the absence of temporal niche differenatiation.
Then, the 
In such a light, Houlahan et al.'s (2007) results can be viewed very differently.
However, Houlahan et al.'s (2007) meausure of compensatory dynamics was summed covariances of species abundances through time.
...
We follow the theory of @Loreau2008a, who derived a statistic to measure community-wide synchrony of per capita population growth rates:
...
Based on the above theory, we aimed to test the following four hypotheses and associated predictions related the synchrony of per capita growth rates:
