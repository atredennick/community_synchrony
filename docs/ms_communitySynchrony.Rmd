...
Removing competition caused, at most, a 5% change in synchrony (Fig. 1).
...
\hl{For example, the species in our communities do not have equivalent environmental and demographic variances (Figs. Sx-Sx), as required by our predictions.}
...
When we removed *A. tripartita* from all simulations, the Idaho results conformed with results from all other sites: removing environmental stochasticity caused a significant reduction in species synchrony (Fig. S4).
