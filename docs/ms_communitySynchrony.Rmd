...
We find this to be true in our simulations: for each community, community synchrony of per capita growth rates are approximately equal to 1/*S* when only demographic stochasticity is acting (Fig. 3; top panels, dark purple lines) and synchrony of percent cover starts at approximately 1/*S* and increases linearly as population sizes increase (Fig. 3; bottom panels, dark purple lines).
