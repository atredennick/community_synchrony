...
To derive analytical predictions we solved a first-order approximation of Equation 2 (Online Supporting Information).
...
Removing competition caused, at most, a 5% change in synchrony (Table S2).
...
The desynchronizing effect of demographic stochasticity modestly counteracted the synchronizing force of the environment, but not enough to lower synchrony to the level observed when only demographic stochasticity is operating (Fig. 2).
...
```{r prediction_table, echo=FALSE, include=TRUE, results='asis', message=FALSE, eval=F, cache=FALSE}
