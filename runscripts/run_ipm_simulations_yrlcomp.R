...
####
Gpars_all <- readRDS("../results/growth_params_yrlycomp_list.RDS")
Spars_all <- readRDS("../results/surv_params_yrlycomp_list.RDS")
Rpars_all <- readRDS("../results/recruit_parameters_yrlycomp.RDS")
