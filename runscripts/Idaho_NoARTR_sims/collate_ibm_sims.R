...
setwd("/Volumes/A02046115/ibm_synch/noARTR/results/")
...
if(nrow(singles)>0){
  ...
  synch_df <- test[-ids.out,]
}

saveRDS(synch_df, "/Users/atredenn/Repos/community_synchrony/runscripts/Idaho_NoARTR_sims/collated_ibm_sims.RDS")
